...
Если SBD торгуются дешевле $1.00 и соотношение долг/собственность высокое, тогда фиды должны быть скорректированы вверх, чтобы увеличить количество STEEM, выдаваемых за SBD. Это увеличит спрос на стим-баксы, в то же время снижая коэффициент долг/собственность тем самым возвращая стим-бакс к долларовому паритету.
