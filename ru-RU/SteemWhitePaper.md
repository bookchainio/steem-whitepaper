...
Steem Dollars обозначаются символом SBD, аббревиатура для Steem Blockchain Dollars. Создание стим-баксов требует: комбинацию мер по обеспечению надежного потока ценовых данных и правил для предотвращения злоупотреблений. Обеспечение надежного потока ценовых данных (далее ценовой фид от англ. price feed) включает три фактора: минимизация последствий некорректного ценового фида, максимизация стоимости производства некорректного ценового фида и минимизация значимости временного фактора.
