...
В Steem производство блоков осуществляется раундами. Каждый раунд для создания и подписания блоков с транзакциями выбирается 21 делегат. Двадцать (20) из этих делегатов избраны путем голосования, а один распределяется между всеми делегатами, которые не вошли в топ 20, пропорционально общему количеству их голосов. 21 активный делегат перемешиваются каждый раунд для предотвращения того, чтобы не было возможности игнорировать блоки производимые тем же самым делегатом. Любой делегат, пропустивший блок и не произведший ни одного нового блока за последние 24 часа, будет отстранен до того момента, как он обновит свой ключ для подписи блоков.
