...
Стим решает проблему давая каждому способ заработать за то, чтобы делать простые, но ценные задачи. Это поможет распределить Стим токены очень широко. This is helpful because cryptocurrencies have a network effect (i.e. more users make it more useful; for an extreme example, consider that if Satoshi had kept 100% of Bitcoin for himself, Bitcoin would be worthless).
