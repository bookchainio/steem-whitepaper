...
Быстрое изменение цены стима может драматическим образом изменять коэффициент долга по отношению к собственному капиталу. Блокчейн предотвращает сильное повышение соотношения долг/собственность, снижая количество стимов, получаемое путем конверсии стим-баксов, если уровень долга превышает 10%. Если сумма долга в стим-баксах когда-либо превысит 10% от общей рыночной капитализации стим, блокчейн автоматически уменьшит количество генерируемых путем конверсии стимов до максимум 10% от рыночной капитализации. Это гарантирует, что блокчейн никогда не будет иметь уровень соотношения долга к собственности выше, чем 10%.
