...
A solução para o problema com micropagamentos está em implementar *reservas fracionárias dinâmicas*. Neste modelo a blockchain ira ajustar automaticamente a taxa de reserva para a rede durante períodos de congestionamento. A blockchain irá definir um alvo de utilização que deixe espaço para aumentos de demanda em curto prazo. A qualquer tempo que os aumentos acontecem a blockchain reduz a largura-de-banda-por-participação. Quando um aumento de uso acabar e existir capacidade extra a blockchain poderá aumentar a largura-de-banda-por-participação aos poucos.
...
A internet representa o meio mais fácil para distribuir informação ao redor do mundo. Dito isso, pode ser um lugar assustador para criadores de conteúdo que desejam possuir o seu próprio conteúdo e tê-lo copartilhado com a atribuição adequada. Nas plataformas de mídia social atuais, a atribuição é algo que pode ser perdido da noite para o dia - um vídeo ou imagem pode ser replicada e recompartilhada sem o consentimento do autor ou respeito pelo criador.

Sobre uma mídia social baseada na blockchain, um criador ou autor seria sempre capaz de apontar para um registro público e uma marca de tempo mostrando a prova da origem do conteúdo. Em uma circunstância aonde o criador gostaria de abordar aqueles que recompartilharam sem permissão ou atribuição, registros baseados na blockchain fornecem uma prova pública que o conteúdo foi publicado por um usuário em particular em um determinado momento. No futuro, a atribuição baseado na blockchain poderia ser reconhecida pelos governos pela sua autenticidade e poderia ter um grande peso no tribunal, o que daria aos criadores de conteúdo grandes poderes para controlar o seu trabalho.

Apesar da marcação de tempo poder ser construído em quase toda blockchain, e vários esforços existem para criar esse tipo de serviço na rede Bitcoin, O Steem tem uma vantagem útil nesse reino porque os publicadores de conteúdo são "cidadãos de primeira classe" -- A blockchain Steem é construída da base ao redor do caso de uso de publicação de conteúdo, o que permite que os criadores de conteúdo tenham a blockchain para validar o seu conteúdo em um certo momento apenas ao escrever a sua publicação utilizando as mesmas ferramentas de autoria utilizados pelos usuários do Steem.

## Substituindo Propaganda pelas Recompensas de Conteúdo baseado em Blockchain

Sob a maioria dos modelos de monetização, os criadores de conteúdo utilizam propagandas de uma forma ou de outra. Muitos criadores reconhecem o quanto propagandas podem reduzir o valor do seu trabalho para o consumidor, mas ainda assim os criadores devem buscar retorno sobre o seu tempo através da monetização. A publicidade representa uma espada de dois gumes: com anúncios, um criador pode fazer dinheiro mais facilmente. Sem anúncios, monetização é mais difícil mas o conteúdo é mais rico.

Criadores publicando em centros de redes sociais que estão conectados ao Steem podem monetizar apenas ao ter o seu trabalho reconhecido (or "ganhar um like") pela comunidade Steem. O pagamento baseados na blockchain são completamente digitais e não tem um intermediador. Sendo assim, a monetização através de recompensas de conteúdo baseadas em blockchain deverão ser uma barreira muito menor para utilização do que monetização via anúncios.
