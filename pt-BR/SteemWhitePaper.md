...
Dólares Steems são referidos com o símbolo SBD, um acrônimo para Steem Blockchain Dollars. A criação de SBD requer uma combinação de um alimentação de preços confiável e regras para evitar abusos. Fornecer uma alimentação de preços confiável envolve três fatores: minimizar o impacto de uma alimentação incorreta, maxizar o custo de produzir uma alimentação incorreta e minimizar a importância do tempo.
