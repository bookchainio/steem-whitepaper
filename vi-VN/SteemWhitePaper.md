...
Từ những lập luận cơ bản trên, chúng ta có thể giả định rằng một hệ thống muốn phát triển dựa vào các khoản phí của người dùng chỉ có hai cách một là tính phí cao cho người dùng, hai là giảm bớt lợi nhuận của những người đồng sở hữu. An individual small owner may profit by renting out his small time slice, but only at the expense of all other timeshare owners. In effect, the cost of the falling timeshare value is shared among all owners whereas the profits are centralized in the single owner who decided to rent his share.
