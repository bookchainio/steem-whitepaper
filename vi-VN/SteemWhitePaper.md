...
Đồng tiền điện tử Ripple dùng số balance tối thiểu[^11] để tạo sự cân trong việc sử dụng nguồn tài khoản và yêu cầu những tài khoản mới phải có số balance tối thiểu. Currently this minimum balance is about $0.15 which is greater than the $0.10 we estimated would allow someone to transact freely at least once per week.
