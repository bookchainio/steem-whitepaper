...
Khi người dùng bỏ phiếu cho một nội dung, tác động của họ đối với sự phân phối tiền thưởng thì tỷ lệ thuận với số lượng SP mà họ có. Người dùng càng có nhiều SP thì sức ảnh hưởng của họ đối với sự phân chia tiền thưởng càng lớn. This means that SP is an access token that grants its holders exclusive powers within the Steem platform.
