...
將貨幣分配給盡可能多的人，這種管道通常被認為是公平的，這是一項具有挑戰性的任務。 可由客觀的電腦算灋完全評估的任務在本質上是有限的，並且一般來說具有有限的正面外延效益。 比特幣式的開採產生了專門硬體的生產，讓人們投入時間開發更有效的算灋。 它甚至可以説明找到質數, 但這些都沒有為社會或貨幣持有的社會提供有意義的價值。 更重要的是，規模經濟和市場力量最終將排除所有人，但專家不會參與這種分配。 Ultimately, computation-based mining is just another way of *buying in* because it requires money to pay the electric bill or the development of hardware necessary to do the work.
