...
Gezamenlijk stemmen Reddit-gebruikers 220 keer per seconde en maken ze 23 berichten per seconde. Reddit wordt gewaardeerd tussen $500 miljoen[^18] en $4 miljard[^19], wat betekent dat elke upvote en post tussen de $0,06 en $0,50 waard is, ervan uitgaande dat de waarde van Reddit meestal binnen de waarde van de activiteit van het afgelopen jaar ligt. One could argue that most of the value of Reddit is the near-real-time discussions that have occurred within the past week which would dramatically increase the value of new activity. People go where people are today, not where people were last year.
