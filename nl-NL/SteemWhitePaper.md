...
Bestaande platformen werken op een één gebruiker, één stem-principe. Dit creëert een omgeving waar rangorde kan worden gemanipuleerd door ‘sybil attacks’, waar een gebruiker meerdere profielen aanmaakt om de rangorde te kunnen beïnvloeden, en waar serviceproviders misbruikers proactief moeten identificeren en blokkeren. Mensen proberen al om de Reddit, Facebook en Twitter score algoritmes te manipuleren wanneer de enige beloning webverkeer of censuur is.
