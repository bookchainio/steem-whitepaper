...
## একটি উৎসাহপ্রদ, ব্লকচেইন ভিত্তিক, পাবলিক কনটেন্ট প্ল্যাটফর্ম।
...
সংগৃহীতভাবে, ব্যবহারকারী-তৈরি সামগ্রী সামাজিক মিডিয়া কোম্পানীর শেয়ারহোল্ডার, যেমন রেডিতিত, ফেসবুক এবং টুইটারের জন্য কোটি কোটি ডলার মূল্যের মান তৈরি করেছে। ** ২0১৪ সালে, Reddit অনুমান করে যে, প্লাটফর্মটি উন্নত হবে যদি যারা Reddit.com এ গল্প পোস্ট করে, মতামত বা ভোটদান যোগ করে যারা Reddit, Inc. এর একটি সুনির্দিষ্ট ভাগের সাথে পুরস্কৃত করেছে, <sup id="fnref:1"><a href="#fn:1" class="footnote-ref">১</a></sup>**। Steem তাদের ক্রিপ্টোকারেন্সি সঙ্গে পুরষ্কার দিয়ে মূল্যবান অবদান প্রদান করে যারা তাদের মূল্য অনেক ফেরত দিয়ে সোশ্যাল মিডিয়া এবং অনলাইন সম্প্রদায়ের সমর্থন লক্ষ্য, এবং এই প্রক্রিয়ার মাধ্যমে একটি এখনো আছে যারা সহ একটি বিস্তৃত বাজারে পৌঁছাতে সক্ষম একটি মুদ্রা তৈরি করুন কোন cryptocurrency অর্থনীতিতে অংশগ্রহণ।
...
একটি সামাজিক মিডিয়া ভিত্তিক অর্থনীতির গ্রহণ এবং নগদীকরণে প্রধান বাধাগুলি চিহ্নিত করার জন্য স্টিম স্থল থেকে ডিজাইন করা হয়েছে। আমার থিসিস উৎপন্ন প্রধান স্যোশাল মিডিয়া প্লাটফর্ম ব্যবহার করা হয়েছে একই কৌশল সফল cryptocurrency বিল টার্নার করতে ব্যবহার করা যায় তা নয়। Economic incentives enabled by cryptocurrency can dramatically facilitate the growth of a new social media platform. It is the synergy between cryptocurrency and social media that we believe may give Steem a powerful advantage in the market.
