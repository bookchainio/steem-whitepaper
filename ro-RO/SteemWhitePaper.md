...
În cazul în care un token este văzut ca proprietate în întreaga aprovizionare de tokeni, atunci un token-convertibil-dolar poate fi văzut ca datorie. Dacă rata datoriei față de proprietate devine prea mare, întreaga monedă poate deveni instabilă. Conversiile de datorie pot crește dramatic stocul de tokeni, care la rândul lui este vândut pe piață, ducând la suprimarea prețului. Subsequent conversions require the issuance of even more tokens. Left unchecked the system can collapse leaving worthless ownership backing a mountain of debt. The higher the debt to ownership ratio becomes the less willing new investors are to bring capital to the table.
