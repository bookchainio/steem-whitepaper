...
有两种方法可以让人们参与到加密货币社区中：他们可以*购买*也可以*做工 *。 在这两种情况下，用户都在向货币增添价值。但绝大多数人*空闲时间*多于* 闲置资金*。 设想在一个没有实际*现金*但有大量*时间* 的贫穷社区中引导货币的目标。 If people can earn money by working for one another then they will bootstrap value through mutual exchange facilitated by a fair accounting/currency system.
