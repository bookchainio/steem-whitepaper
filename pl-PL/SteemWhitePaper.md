...
Wyobraź sobie sytuację, w której serwisy, których używamy codziennie naliczałyby opłaty za każdym razem, gdy podejmujemy jakąś akcję, np. zmieniamy hasło. Użytkownicy oczekują, że pewne rzeczy pozostaną darmowe. Wymaganie od użytkownika podejmowania decyzji, w której musi zadecydować czy podjęcie działania jest warte opłacenia mikrotransakcji sprawia, że szybko opuści on platformę. A transaction can’t be worth so much as to require a decision but worth so little that that decision is automatic. There is a certain amount of anxiety involved in any decision to buy, no matter how small, and it derives not from the interface used or the time required, but from the very act of deciding.
