...
Na szczęście, każdy wkład pracy, który otrzymuje duże skoncentrowanie głosów, otrzymuje także największy nadzór poprzez rozgłos. Poprzez dodawanie mechanizmu oddawania *negatywnego głosu* możliwe staje się, by wielu mniejszych interesariuszy wspólnymi siłami odebrały władzę zmówionym dużym jednostkom. Co więcej, liczący się udziałowcy mają więcej do stracenia, jeżeli waluta zacznie spadać z powodu ich nadużyć, więc okazuje się to dla nich nieopłacalne. In fact, honest large stakeholders are likely to be more effective by policing abuse and using negative voting than they would be by voting for smaller contributions.
