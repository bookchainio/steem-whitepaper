...
Dolary Steem odwołują się do symbolu SBD, akronimu od Steem Blockchain Dollars. Utworzenie SBD wymaga połączenia notowań godnych zaufania oraz zasad, które pozwolą uniknąć nadużyć. Providing a reliable price feed involves three factors: minimizing the impact of an incorrect feed, maximizing the cost of producing an incorrect feed, and minimizing the importance of timing.
