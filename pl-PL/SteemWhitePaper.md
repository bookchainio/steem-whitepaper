...
Proces ten jest zaprojetowany tak, by dostarczać maksymalną wierzytelność przy jednoczesnym zachowaniu pewności, że każdy ma potencjał do produkcji bloków bez względu na jego popularność. Ludzie mają trzy opcje przezwyciężania cenzury narzuconej przez 20 wybranych świadków. Mogą cierpliwie poczekać w kolejce ze wszystkimi innymi użytkownikami, którzy nie należą do top 20 lub nabyć więcej SP, żeby zwiększyć swoją siłę głosu. Co więcej, świadkowie, którzy stosują cenzurę, mogą łatwo stracić swoją pracę. Wydaje się więc, że cenzura nie będzie problemem dla platformy Steem.
