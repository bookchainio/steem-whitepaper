...
Ang mga Steem Dollar ay tinutukoy sa simbolo ng SBD, isang acronym para sa mga Steem Blockchain Dollar. Ang paglikha ng SBD ay nangangailangan ng isang kumbinasyon ng maaasahang feed ng presyo, at mga patakaran upang maiwasan ang pang-aabuso. Providing a reliable price feed involves three factors: minimizing the impact of an incorrect feed, maximizing the cost of producing an incorrect feed, and minimizing the importance of timing.
