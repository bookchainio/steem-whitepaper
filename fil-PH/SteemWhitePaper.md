...
Ang solusyon sa mga problema sa mga micropayment ay ang pagpapatupad ng *dinamikang praksyonal na mga reserba*. Sa ilalim ng modelong ito ang blockchain ay awtomatikong aayusin ang proposyon ng reserba para sa network sa mga oras ng kasikipan. The blockchain will set a target utilization that leaves enough headroom for short term surges in demand. Any time the surges are sustained the blockchain reduces the maximum bandwidth-per-share. When a surge is over and there is surplus capacity the blockchain can slowly increase the bandwidth-per-share.
