...
Ang walang muwang na proseso sa pagboto ay lumilikha ng isang Problema ng mga bilanggong N-Tao[^5] kung saan ang bawat indibidwal na botante ay may insentibo na bumoto para sa kanilang sarili sa gastos ng mas malaking layunin ng komunidad. If every voter defects by voting for themselves then no currency will end up distributed and the currency as a whole will fail to gain network effect. On the other hand, if only one voter defects then that voter would win undeserved profits while having minimal effect on the overall value of the currency.
