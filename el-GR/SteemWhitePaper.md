...
Η πρόκληση βρίσκεται στο να δημιουργηθεί ένα σύστημα ικανό να αναγνωρίσει ποιες συνεισφορές είναι χρήσιμες και ποια η σχετική τους αξία, με ένα τρόπο που μπορεί να κλιμακωθεί σε έναν αριθμό ανθρώπων χωρίς όριο.
