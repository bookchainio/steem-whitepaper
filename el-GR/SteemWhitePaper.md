...
Το Steem είναι η θεμελιώδης μονάδα λογιστικής πάνω στο Steem blockchain. Όλα τα άλλα σύμβολα αποκομίζουν την αξία τους από την αξία του STEEM. Το STEEM είναι ένα ρευστό νόμισμα, οπότε μπορεί είτε να αγοραστεί ή να πουληθεί σε ανταλλακτήρια, ή να μεταφερθεί σε τρίτους ως μια μορφή πληρωμής.
