...
Μεταφορά από STEEM σε SP αναφέρεται ως «αναβάθμιση», ενώ τη μεταφορά από SP σε STEEM αναφέρεται ως «υποβάθμιση». Τα SP που υποβαθμίζονται επιστρέφονται στο χρήστη σε μια περίοδο δεκατριών εβδομάδων, μέσω 13 ίσων εβδομαδιαίων πληρωμών, αρχίζοντας μία εβδομάδα μετά την έναρξη της υποβάθμισης.
