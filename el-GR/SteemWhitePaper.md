...
Η συνεισφορά ψήφου από τα μέλη της κοινότητας είναι κρίσιμη στο Steem για την ακριβή διανομή πληρωμών στους συνεισφέροντες. Επομένως, η ψηφοφορία μπορεί να φανεί σαν μια κρίσιμη συνεισφορά και είναι άξια ανταμοιβής από μόνη της. Μερικές πλατφόρμες, όπως το Slashdot, χρησιμοποιούν meta-moderation[^3] σαν ένα τρόπο κατάταξης και ανταμοιβής των τίμιων moderators. Το Steem επιλέγει να ανταμείψει αυτούς που συνεισφέρουν περισσότερο στην συνολική προώθηση του κάθε περιεχομένου και ανταμείβει τους ψηφοφόρους σε αναλογία με την τελική ανταμοιβή που θα λάβει ο δημιουργός του περιεχομένου.

# Τρόποι συνεισφοράς

Αυτό το κεφάλαιο περιγράφει συνοπτικά τις ιδέες πίσω από το Steem και τις ανταμοιβές για τους ανθρώπους που παρέχουν σημαντικές και μετρήσιμες συνεισφορές στην κοινότητα Steem.
