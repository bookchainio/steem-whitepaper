...
Στο σχεδιασμό του Steem χρησιμοποιήθηκαν κάποιες βασικές αρχές. Η πιο βασική αρχή είναι ότι όλοι όσοι συνεισφέρουν σε μια επιχείρηση θα πρέπει να λαμβάνουν ένα μέρος της ιδιοκτησίας, των πληρωμών ή του χρέους από την επιχείρηση στο αντίστοιχο ποσοστό. Αυτή η αρχή είναι η ίδια αρχή που εφαρμόζεται σε όλες τις νεοφυείς επιχειρήσεις, που διανέμουν μερίδια μετοχών κατά την ίδρυση και κατά την διάρκεια ακόλουθων γύρων χρηματοδότησης.

Η δεύτερη αρχή είναι ότι όλες οι μορφές κεφαλαίου είναι εξίσου πολύτιμες. Αυτό σημαίνει ότι αυτοί που συνεισφέρουν τον χρόνο τους και προσοχή προς την δημιουργία και σύσταση περιεχομένου για άλλους είναι τόσο πολύτιμοι όσο αυτοί που συνεισφέρουν τα χρήματά τους. Αυτή είναι η αρχή της δίκαιης κατανομής εργασίας[^2], και είναι μια έννοια που προηγούμενα κρυπτονομίσματα συχνά είχαν πρόβλημα να παρέχουν σε παραπάνω από μερικούς χιλιάδες χρήστες.

Η τρίτη αρχή είναι ότι η κοινότητα παράγει προϊόντα προς εξυπηρέτηση των μελών της. Αυτή η αρχή εφαρμόζεται παραδειγματικά από πιστωτικές ενώσεις, σχέδια συνεργατικής σίτισης και σχέδια καταμερισμού υπηρεσιών υγείας, που υπηρετούν τα μέλη της κοινότητας τους παρά να πουλούν τα προϊόντα ή τις υπηρεσίες τους σε ανθρώπους έξω από την κοινότητα.
...
Η σκόπιμη ανακατάταξη των οικονομικών κινήτρων από το Steem έχει την δυνατότητα να παράγει δικαιότερα και ευρύτερα αποτελέσματα για όλους όσους εμπλέκονται, σε σχέση με τα μέσα κοινωνικής δικτύωσης και τις πλατφόρμες κρυπτονομισμάτων που υπήρχαν πριν από αυτό. Αυτή η αναφορά θα διερευνήσει τα υπάρχοντα οικονομικά κίνητρα και θα καταδείξει πώς τα κίνητρα του Steem μπορούν να οδηγήσουν σε καλύτερα αποτελέσματα για τους περισσότερους συμμετέχοντες.

## Αναγνωρίζοντας την συνεισφορά

Το Steem έχει σχεδιαστεί εξαρχής για να απευθυνθεί στα κύρια εμπόδια της υιοθέτησης και νομισματοποίησης μιας οικονομίας βασισμένης στα μέσα κοινωνικής δικτύωσης. Η θέση μας είναι ότι οι ίδιες τεχνικές που χρησιμοποιούνται για να μεγαλώσουν τις μεγάλες πλατφόρμες κοινωνικής δικτύωσης μπορούν να χρησιμοποιηθούν για να "χτίσουν" ένα επιτυχημένο κρυπτονόμισμα. Τα οικονομικά κίνητρα που παρέχονται από το κρυπτονόμισμα μπορούν να διευκολύνουν δραματικά την ανάπτυξη μιας νέας πλατφόρμας κοινωνικής δικτύωσης. Αυτή η συνέργεια μεταξύ κρυπτονομίσματος και κοινωνικών δικτύων πιστεύουμε ότι μπορεί να δώσει στο Steem ένα δυνατό πλεονέκτημα στην αγορά.

Η πρόκληση που αντιμετωπίζει το Steem είναι να αποκομίσει έναν αλγόριθμο αξιολόγησης της συνεισφοράς, που η πλειοψηφία των μελών της κοινότητας να θεωρούν ως δίκαιη εκτίμηση της υποκειμενικής αξίας από κάθε συνεισφορά. Σε ένα τέλειο κόσμο, τα μέλη της κοινότητας θα συνεργάζονταν για να εκτιμήσουν την συνεισφορά καθενός και να αποκομίσουν μια δίκαιη αποζημίωση. Στον πραγματικό κόσμο, πρέπει να σχεδιαστούν αλγόριθμοι που να είναι ανθεκτικοί σε εσκεμμένη χειραγώγηση για κέρδος. Οποιαδήποτε ευρεία κακομεταχείριση του συστήματος βαθμολόγησης θα μπορούσε να προκαλέσει τη δυσαρέσκεια των μελών της κοινότητας όσον αφορά την αντιληπτή δικαιοσύνη του οικονομικού συστήματος.

Οι υπάρχουσες πλατφόρμες λειτουργούν με την αρχή του ενός-χρήστη, μιας-ψήφου. Αυτό δημιουργεί ένα περιβάλλον όπου οι σειρές κατάταξης μπορούν να χειραγωγηθούν από επιθέσεις Sybil (πολλαπλοί ψεύτικοι λογαριασμοί) και οι πάροχοι της υπηρεσίας πρέπει να αναγνωρίσουν και να αναχαιτίσουν τους καταχραστές αμέσως. Οι άνθρωποι ήδη επιχειρούν να χειραγωγήσουν το σύστημα βαθμολόγησης του Reddit, του Facebook και του Twitter όταν η μόνη ανταμοιβή είναι το web traffic και η λογοκρισία.

Η θεμελιώδης μονάδα αξίας στην πλατφόρμα του Steem είναι το STEEM, ένα κρυπτονόμισμα. Το Steem λειτουργεί επί την βάση του ένα-STEEM, μια-ψήφος. Υπό αυτό το μοντέλο, άτομα που έχουν συνεισφέρει τα περισσότερα σε αυτή την πλατφόρμα, όπως μετράται από το υπόλοιπο του λογαριασμού τους, έχουν την περισσότερη επιρροή στο πως αξιολογούνται οι συνεισφορές. Επιπλέον, το Steem επιτρέπει στα μέλη να ψηφίζουν με STEEM όταν δεσμεύεται σε ένα χρονοδιάγραμμα κατοχύρωσης. Υπό αυτό το μοντέλο, τα μέλη έχουν ένα οικονομικό κίνητρο να ψηφίσουν με τέτοιο τρόπο που να μεγιστοποιεί την μακροπρόθεσμη αξία των STEEM τους.
