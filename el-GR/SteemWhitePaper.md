...
Η συνεισφορά ψήφου από τα μέλη της κοινότητας είναι κρίσιμη στο Steem για την ακριβή διανομή πληρωμών στους συνεισφέροντες. Επομένως, η ψηφοφορία μπορεί να φανεί σαν μια κρίσιμη συνεισφορά και είναι άξια ανταμοιβής από μόνη της. Μερικές πλατφόρμες, όπως το Slashdot, χρησιμοποιούν meta-moderation[^3] σαν ένα τρόπο κατάταξης και ανταμοιβής των τίμιων moderators. Το Steem αποφασίζει να ανταμείψει αυτούς που συνεισφέρουν το περισσότερο στην συνολική προώθηση ενός κομματιού περιεχομένου και ανταμείβει τους ψηφοφόρους αναλογικά με την τελική ανταμοιβή που θα πληρωθεί ο δημιουργός του περιεχομένου.

# Τρόποι συνεισφοράς

Αυτός ο τομέας περιγράφει συνοπτικά τις ιδέες πίσω από το Steem και τις ανταμοιβές για τους ανθρώπους που παρέχουν σημαντικές και μετρήσιμες συνεισφορές στην κοινότητα Steem.

## Συνεισφορές κεφαλαίου

Υπάρχουν δύο στοιχεία που μπορεί να προσφέρει μια κοινότητα για να προσφέρει για να προσελκύσει κεφάλαιο: το χρέος και η ιδιοκτησία. Αυτοί που αγοράζουν ιδιοκτησία βγάζουν κέρδος όταν η κοινότητα μεγαλώνει αλλά χάνουν όταν η κοινότητα συρρικνώνεται. Αυτοί που αγοράζουν χρέος έχουν ένα συγκεκριμένο ποσοστό ενδιαφέροντος (τοκισμού) εγγυημένο, αλλά δεν έχουν συμμετοχή σε οποιαδήποτε κέρδη προκύπτουν από την ανάπτυξη της κοινότητας. Και οι δύο τύποι συνεισφοράς κεφαλαίου είναι πολύτιμοι στην ανάπτυξη της κοινότητας και την αξία του νομίσματός της. Επιπλέον υπάρχουν δύο τρόποι που μπορεί να κατοχυρωθεί η ιδιοκτησία: Ρευστό και κατοχύρωση. Η κατοχύρωση ιδιοκτησίας δημιουργεί μια μακροπρόθεσμη δέσμευση και δεν μπορεί να πουληθεί για ελάχιστο χρονικό διάστημα.

Το δίκτυο του Steem αποκαλεί αυτές τις διαφορετικές κατηγορίες περιουσιακών στοιχείων Steem (STEEM), δύναμη Steem (SP) και δολάρια Steem (SBD).
