...
Το Steem είναι σχεδιασμένο γύρω από μια σχετικά απλή έννοια: *η σημαντική συνεισφορά όλων στην κοινότητα θα πρέπει να αναγνωρίζεται για την αξία που προσθέτει.* Όταν οι άνθρωποι αναγνωρίζονται για τη συνεισφορά τους, συνεχίζουν να συνεισφέρουν και η κοινότητα μεγαλώνει. Οποιαδήποτε ανισορροπία στο πάρε δώσε μέσα στην κοινότητα είναι ασυντήρητο. Τελικά οι δότες κουράζονται να υποστηρίζουν τους λήπτες και απεμπλέκονται από την κοινότητα.
