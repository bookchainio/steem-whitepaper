...
Η Υποκειμενική Απόδειξη Εργασίας (Proof of Work) παρουσιάζει μια εναλλακτική προσέγγιση στην διανομή ενός νομίσματος που βελτιώνει πλήρως *τα αντικειμενικά* συστήματα απόδειξης δουλειάς όπως η εξόρυξη. Οι εφαρμογές ενός νομίσματος που εφαρμόζει σύστημα *αντικειμενικών* αποδείξεων εργασίας είναι πολύ πιο ευρείες από *οποιοδήποτε* σύστημα υποκειμενικής απόδειξης εργασίας, γιατί μπορούν να χρησιμοποιηθούν για να χτίσουν μια κοινότητα γύρω από οποιαδήποτε έννοια που έχει έναν επαρκώς καθορισμένο σκοπό. Όταν τα άτομα γίνονται μέλη σε μια κοινότητα, επενδύουν σε ένα συγκεκριμένο σύνολο απόψεων και μπορούν να ψηφίσουν για να ενισχύσουν τις αξίες ή τον σκοπό της κοινότητας.
