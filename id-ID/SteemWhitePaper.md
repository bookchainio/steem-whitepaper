...
Masukan pemilih dari anggota masyarakat sangat penting bagi Steem untuk secara akurat mengalokasikan pembayaran kepada kontributor. Voting oleh karena itu dapat dipandang sebagai kontribusi penting dan layak mendapat penghargaan tersendiri. Some platforms, such as Slashdot, use meta-moderation[^3] as a way to rank and reward honest moderators. Steem chooses to reward those who contribute the most to the total promotion of a piece of content and rewards the voters proportional to the ultimate reward paid to the content creator.
