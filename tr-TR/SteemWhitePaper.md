...
Kripto para birimleri tarafindan kullanilan algoritmalar oydasmaya ulasabilmek icin cok daha iyi bir yol sunar. Tüm kullanicilar tarafindan kriptografik olarak imzalalanmis yeminler, mutlak küresel olaylar siralamasini kuran kamuya acik bir kayit defterine kaydedilir. A deterministic computer algorithm can then process this ledger to derive a universally accepted conclusion. So long as the members of a community agree on the processing algorithm, the result of the algorithm is authoritative.
