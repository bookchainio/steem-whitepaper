...
Steem Dolar'ı, başlangıçları finanse etmek için sıklıkla kullanılan dönüştürülebilir notlara benzer bir mekanizma ile oluşturulur. Startup dünyasında, çevrilebilir notlar gelecekte belirlenecek bir oranda, genellikle gelecekteki bir fonlama turunda sahipliğe dönüştürülebilen kısa vadeli borçlanma araçlarından oluşur. Bir blok zincirine dayanan para, toplulukta mülkiyet olarak görülebilirken çevrilebilir not, herhangi bir başka emtia veya para biriminde gösterilen bir borç olarak görülebilir. Cabrio notunun şartları, sahibinin token'ini uygun fiyatında minimum bildirimle destekleyici simgeye dönüşmesine izin verir. Simgeleri dönüştürülebilir-dolarlar oluşturmak, blok zincirlerinin ağ efektlerini büyütmesini ve simge sahiplerine dönüşü en üst düzeye çıkarmasını sağlar.
