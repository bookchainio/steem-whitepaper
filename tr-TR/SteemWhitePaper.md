...
Eğer bir kullanıcının her hafta bir kere 25$ Dolarlık BTC işlemi yaptığını ve 0.04$ sentlik işlem ücreti ödediğini farz edersek; o zaman bu kullanıcı yılda 2$ Doların üzerinde işlem ücreti ödeyecektir. Kullanıcı, bahse konu 25$ doları için %8'lik bir gelir oranı elde ediyor olmalıdır ki ödemekte olduğu işlem ücretlerinin masrafını çıkartabilsin. Pek muhtemeldir ki, kullanıcılar her şekilde paralarını blockchainde tutacaktır. Yani, bu 25$ değerinde BTC sahibi olan kullanıcı, ücret-temelli yaklaşım yerine oran-sınırlı yaklaşımın benimsenmesiyle yıl boyunca 2$ tasarruf etmektedir. Sadece 175$ ile her gün işlem yapabilirler ve günlük 14$ tasarruf edebilirler.
