...
Herkese dahil olabilme esitligi ve para birimi kazanabilme esitligi taniyabilmek adina insanlara calisma esitligi saglanmalidir. Zor olan, bireylerin ürettigi isin göreli niceliginin ve niteliginin nasil degerlendirilecegi ve bunun öyle bir yolla yapilmasidir ki milyonlarca üyeye ödülleri efektif bir sekilde dagitilsin. This requires the introduction of a scalable voting process. In particular it requires that authority to allocate funds must be as distributed and decentralized as possible.
