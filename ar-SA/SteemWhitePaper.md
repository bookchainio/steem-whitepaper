...
الوحدة الأساسية للحساب على منصة ستيم هي STEEM، رمز العملة الإفتراضية. يعمل ستيم على أساس ستيم واحد، صوت واحد. Under this model, individuals who have contributed the most to the platform, as measured by their account balance, have the most influence over how contributions are scored. Furthermore, Steem only allows members to vote with STEEM when it is committed to a vesting schedule. وبموجب هذا النموذج، يتمتع الأعضاء بحافز مالي للتصويت بطريقة تزيد إلى أقصى حد من قيمة الستيم الخاص بهم.
