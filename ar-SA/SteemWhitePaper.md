...
يستخدم ريبل الحد الأدنى من الرصيد [^11] الذي يتم موازنته باستخدام موارد الحساب ويتطلب تمويل الحسابات الجديدة مع الحد الأدنى لهذا الرصيد على الأقل. Currently this minimum balance is about $0.15 which is greater than the $0.10 we estimated would allow someone to transact freely at least once per week.
