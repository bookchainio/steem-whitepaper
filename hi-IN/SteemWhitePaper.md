...
स्टीम आर्थिक समीकरण को बदलकर, योगदान के सभी प्रकार के लिए प्रभावी छोटी दर की राशि को सक्षम बनाता है । पाठकों को अब ये तय नहीं करना पड़ेगा कि वो किसी को अपनी जेब से भुगतान करें या न करें, इसके बजाय वो किसी सामग्री पर अपना वोट ऊपर या नीचे कर सकते हैं और स्टीम उनके वोटों का उपयोग करके व्यक्तिगत पुरस्कार निर्धारित करेंगे । This means that people are given a familiar and widely used interface and no longer face the cognitive, financial, and opportunity costs associated traditional micropayment and tipping platforms.
