...
Il problema basilare di addebitare le commisioni per le transazioni è che i micropagamenti non funziona, specialmente per le azioni di basso valore degli utenti. Quando una commissione viene addebitata in ogni transazione, limita i tipi di transazioni che una rete decentralizzata può elaborare. Regardless of how rational the argument for the necessity of fees, users still hate the experience of being nickeled and dimed for everything that they do.
