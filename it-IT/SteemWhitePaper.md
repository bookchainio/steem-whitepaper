...
Ci sono due modi con i quali le persone possono venire coinvolte in una comunità di criptovalute: loro possono *comprarle* o possono *lavorarci*. In entrambi i casi, gli utenti stanno apportando valore alla valuta, anche se, la grande maggioranza delle persone ha più *tempo libero* di quanto *denaro risparmino*. Immaginate l'obbiettivo di avviare una valuta in una comunità povera senza che abbia realmente *denaro* ma *tempo* in abbondanza. Se le persone possono guadagnare lavorando l'uno per l'altra, avvieranno il processo di valorizzazione attraverso scambi reciproci, facilitati da un equo sistema contabile/monetario.

Distribuire la moneta a più persone possibili in un metodo che generalmente viene percepito come equo, è un compito difficile. I compiti che possono essere interamente valutati da un algoritmo oggettivo di un computer, sono naturalmente limitati e, parlando in generale, hanno benefici positivi esterni limitati. Nel caso del minare (mining) secondo la metodologia utilizzata dal Bitcoin, questo può risultare in una produzione di hardware specializzati e indurre le persone a investire del tempo sviluppando algoritmi più efficienti. Questo potrebbe anche aiutare a trovare numeri primi, ma nessuna di queste cose fornisce un valore significativo alla società o, in generale, alla comunità che detiene la valuta. Ma ancora più importante è che le economie di scala e le forze di mercato finiranno escludendo tutti tranne gli esperti, dal partecipare in questo tipo di distribuzione. In definitiva, il mining basato sui calcoli è solo un altro modo di *acquistare* perché richiede denaro per pagare la bolletta elettrica o lo sviluppo dell'hardware necessario per eseguire il lavoro.

Per dare a tutti pari opportunità per essere coinvolti e guadagnare la valuta, alle persone deve essere data una opportunità di lavorare. La sfida è come giudicare la relativa qualità e quantità del lavoro che gli individui forniscono e farlo in un modo che distribuisce efficientemente le ricompense a milioni di utenti. Questo richiede l'introduzione di processi di voto scalabili. In particolare, questo richiede che l'autorità per la distribuzione dei fondi, debba essere più distribuita e decentralizzata possibile.
...
Fortunatamente, ogni lavoro che riceve una grande concentrazione di voti, guadagna anche il maggior controllo (pubblicamente). Attraverso l'aggiunta di *votazioni negative*, per molti stakeholder (parti interessate) più piccoli, è possibile annullare il potere di voto di gruppi collusivi o danneggiare i grossi stakeholders. Furthermore, large-stakeholders have more to lose if the currency falls in value due to abuse than they might gain by voting for themselves. In fact, honest large stakeholders are likely to be more effective by policing abuse and using negative voting than they would be by voting for smaller contributions.
