...
Ripple utilizza un minimo saldo[^11] che bilancia con l'utilizzo delle risorse dell'account e richiede che i nuovi account vengano finanziati con questo saldo minimo. Currently this minimum balance is about $0.15 which is greater than the $0.10 we estimated would allow someone to transact freely at least once per week.
