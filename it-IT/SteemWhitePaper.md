...
La larghezza di banda utilizzata da un singolo utente dovrebbe essere misurata su un periodo di tempo sufficientemente lungo per permettere a quell'utente lo slittamento temporale del suo utilizzo. Gli utenti tendono a connettersi, fare molte cose contemporaneamente e quindi disconnettersi. Questo vuol dire che la loro larghezza di banda lungo un periodo di tempo breve può sembrare maggiore rispetto a se viene vista lungo un periodo di tempo più lungo. Se l'intervallo di tempo viene allungato in modo eccessivo, il livello di riserva non si regolerà abbastanza velocemente per rispondere ai picchi di breve durata e, se l'intervallo è troppo breve, il clustering (composto da tecniche per analizzare gruppi) utilizzato avrà un impatto troppo grande sugli utenti normali.
