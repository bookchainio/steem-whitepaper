...
La larghezza di banda utilizzata da un singolo utente dovrebbe essere misurata su un periodo di tempo sufficientemente lungo per permettere a quell'utente lo slittamento temporale del suo utilizzo. Gli utenti tendono ad connettersi, fare molte cose contemporaneamente e quindi disconnettersi. Questo vuol dire che la loro larghezza di banda lungo un periodo di tempo breve può sembrare maggiore rispetto a se viene vista lungo un periodo di tempo più lungo. If the time window is stretched too far then the reserve ratio will not adjust fast enough to respond to short-term surges, if the window is too short then clustering usage will have too big of an impact on normal users.
