...
Agli utenti viene assegnato un ammontare fisso di potere di voto (voting power). Il potere di voto viene moltiplicato per i token dell'utente vincolati, per determinare la quantità della quota che si trova nella pool delle ricompense e che deve essere assegnata ad un determinato elaborato articolo. Ogni voto che viene dato, usa utilizza percentuale del rimanente potere di voto. Gli utenti possono votare per più articoli, ma, ogni voto diminuirà di valore e necessiterà di più tempo per raggiungere nuovamente il pieno potere di voto. Il potere di voto si ricarica ad un tasso lineare fisso del 20% al giorno.
